...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var points = [];
  var latlngs = []; // Array to store the latlngs for the polyline
  ...
  var endIcon = L.icon({
    iconUrl: 'https://cdn-icons-png.flaticon.com/128/11590/11590229.png',
    // Replace with your icon URL
    iconSize: [46, 46],
    // Size of the icon
  ...
  locations.forEach(function (loc, index) {
    ...
    L.marker(latlng, {
      icon: icon
    }).addTo(map).bindPopup("<p>".concat(index === 0 ? "Start Location Day ".concat(loc.day) : index === locations.length - 1 ? "End Location ".concat(loc.day) : "Day ".concat(loc.day), ": ").concat(loc.description, "</p>"), {
      autoClose: false
    }).openPopup();
  });
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  if (type === 'success') {
    icon = '  <div class="success-symbol" style="width: 20px;height: 20px; margin-right: 10px; "><img src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Eo_circle_green_checkmark.svg" alt="Success" /></div> ';
  } else {
    icon = '  <div class="success-symbol" style="width: 20px;height: 20px; margin-right: 10px; "><img src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Cross_red_circle.svg" alt="Success" /></div> ';
  }
  // console.log('icon', icon);

  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(icon, " ").concat(msg, " </div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (response.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Welcome To TourMate!');
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, name, password_confirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          window.setTimeout((0, _alerts.showAlert)('success', 'Logged Out successfully!'), 1500);
...
var passwordReset = exports.passwordReset = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(password, password_confirm, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          (0, _alerts.showAlert)('token', token);
          _context.prev = 1;
          if (!(!token || token === undefined)) {
            _context.next = 6;
            break;
          }
          (0, _alerts.showAlert)('failure', 'There Is Some Issue With Token So Please Try Again Later!');
          window.setTimeout(function () {
            location.assign('/login');
          }, 1500);
        ...
        case 6:
          _context.next = 8;
          return _axios.default.patch("http://localhost:3000/api/v1/users/conf/resetPassword/".concat(token), {
            password: password,
            password_confirm: password_confirm
          });
        case 8:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post("http://localhost:3000/api/v1/users/forgotPassword", {
            email: email
          });
        case 3:
          res = _context.sent;
          ...
          console.log('res', res);
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email Send Successfully TO Your Email');
            window.setTimeout(function () {
              location.assign('/login');
            }, 1500);
          }
...
exports.UpdateReview = exports.PostReview = exports.DeleteReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://localhost:3000/api/v1/reviews', {
            rating: rating,
            review: review,
            tourId: tourId
          });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.patch("http://localhost:3000/api/v1/reviews/".concat(reviewId), {
            rating: rating,
            review: review
          });
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          console.log('err', _context3.t0.response);
          window.setTimeout(function () {
            location.assign('/my-review');
          }, 2500);
...
var _passwordReset = require("./passwordReset.js");
...
// Get modal element
var modal = document.querySelectorAll('.reviewModal');
// Get modal element
var modalUpdate = document.querySelectorAll('.updateModal');
var modalDelete = document.querySelectorAll('.deleteModal');
// Review Card Before Post
var reviewBefore = document.getElementById('reviewBefore');
// After
var reviewAfter = document.getElementById('reviewAfter');

// Get the button that opens the modal
// const openModalBtn = document.getElementById('openModalBtn');
var openModalBtns = document.querySelectorAll('.openModalBtn');
var openUpdateModalBtns = document.querySelectorAll('.openUpdateModalBtn');
var openDeleteModalBtns = document.querySelectorAll('.openDeleteModalBtn');

// Get the cancel button inside modal
var cancelBtn = document.querySelectorAll('.cancelBtn');
var cancelUpdateBtn = document.querySelectorAll('.cancelUpdateBtn');
var cancelDeleteBtn = document.querySelectorAll('.cancelDeleteBtn');

// Get all star elements
// const stars = document.querySelectorAll('.star');

// Get post button inside modal
var postBtn = document.querySelectorAll('.postBtn');
...
if (openModalBtns) {
  openModalBtns.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
      ...
      var stars = modal[index].querySelectorAll('.star');
...
if (postBtn) {
  postBtn.forEach(function (btn, index) {
    btn.addEventListener('click', function (e) {
      ...
      var cancelButton = modalContent.querySelector('.btn-cancel');
      cancelButton.disabled = true;
      var rating = ratingValue;
      var tourId = this.getAttribute('data-tour-id');
      var textarea = document.querySelector("textarea[data-tour-id=\"".concat(tourId, "\"]"));
      var review = textarea.value;
      console.log('reviewewfd', rating, tourId, review);
      (0, _review.PostReview)(rating, review, tourId);
...
if (openUpdateModalBtns) {
  openUpdateModalBtns.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
      modalUpdate[index].style.display = 'block';
      var stars = modalUpdate[index].querySelectorAll('.star');
      var rating = parseInt(this.getAttribute('data-rating'));
      console.log('rating', rating, _typeof(rating));
...
if (updateBtn) {
  updateBtn.forEach(function (btn, index) {
    btn.addEventListener('click', function (e) {
      ...
      var rating = ratingValue;
      var review = modalContent.querySelector('.review').value;
      // console.log('reviewewfd', rating, review, reviewId);

      (0, _review.UpdateReview)(rating, review, reviewId);
    });
  });
}
if (cancelUpdateBtn) {
  cancelUpdateBtn.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
...
if (window) {
  ...
  window.onclick = function (event) {
    modalUpdate.forEach(function (modal) {
...
if (openDeleteModalBtns) {
  openDeleteModalBtns.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
...
if (cancelDeleteBtn) {
  cancelDeleteBtn.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
...
if (deleteBtn) {
  deleteBtn.forEach(function (btn, index) {
    btn.addEventListener('click', function (e) {
      ...
      // Disable the corresponding Cancel button
      var modalContent = e.target.closest('.modal-content-delete');
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn-reset').textContent = 'Reseting...';
    ...
    (0, _passwordReset.passwordReset)(password, password_confirm, token);
  });
}
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn-forgot').textContent = 'SendingEmail...';
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var password_confirm = document.getElementById('password_confirm').value;
    (0, _signup.signup)(email, password, name, password_confirm);
  });
}
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          password_current = document.getElementById('password-current').value;
